                    ...
                    <form action="{{ route('pasien.login.store') }}" method="POST" class="mt-8 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" id="nik" maxlength="16" placeholder="0000000000000000"
                                required
                                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#D91A8B] focus:border-[#D91A8B]">
                        </div>
                        <div>
                        ...
                        <div class="pt-4">
                            <button type="submit"
                                class="w-full flex justify-center py-3 px-4 border border-transparent rounded-2xl text-sm font-medium text-white bg-[#D91A8B] hover:bg-[#c4177c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D91A8B] shadow-[0_10px_20px_-10px_rgba(217,26,139,0.6)]">
                                Login Pasien
                            </button>
                        </div>
                    </form>
